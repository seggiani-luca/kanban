...
\begin{itemize}
	...
	\item \lstinline|net/|: il \textit{modulo di rete}, gestisce i socket e li astrae dagli altri moduli. Nel server, fornisce il concetto di \lstinline|connection| con un client;
...
In questo modo si riescono a gestire le richieste dirette al client nei \textit{"momenti morti"} accennati sopra.
\begin{lstlisting}[language=C++]	
